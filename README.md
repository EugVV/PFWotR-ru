...
* Другие изменения в переводе:
  ...
  * имена: Hawkblade — Бросок Ястреба (в основном был Бросок ястреба), Klaem — Клам (был Клэйм), Sarenrae — Саренрей (была Саренрэй), Shamira the Ardent Dream — Шамира Пылкая Грёза (была Шамира Пылкая греза), Sunhammer — Солнечный Молот (был Солнечный молот);
